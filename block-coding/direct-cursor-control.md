---
layout: page
title: Direct Cursor Control Resources
permalink: /block-coding/direct-cursor-control/
---
...
<div style="border-left: 4px solid #2a7ae2; padding: 20px; margin: 20px 0; background-color: #f8f9fa;">
    <h4 style="margin-top: 0;">Workspace Organisation</h4>
    <ul>
        <li>Zoom in to make blocks larger and easier to grab</li>
        <li>Use the "Clean up blocks" feature to organise your workspace</li>
